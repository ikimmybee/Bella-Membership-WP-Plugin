...
?>
	...
	<form action="" method="post" enctype="multipart/form-data"> 
		<h2><?php _e('Email Settings', 'bella-membership-plugin' );?></h2>
		...
		<tbody>                
			<tr>
				<th scope="row" valign="top">
					<label for="from_email"><?php _e('From Email', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
			...
			<tr>
				<th scope="row" valign="top">
					<label for="from_name"><?php _e('From Name', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
			...
			<tr>
				<th scope="row" valign="top">
					<label for="only_filter_pmpro_emails"><?php _e('Only Filter PMPro Emails?', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
					...
					<label for="only_filter_pmpro_emails"><?php printf( __('If unchecked, all emails from "WordPress &lt;%s&gt;" will be filtered to use the above settings.', 'bella-membership-plugin' ),  $default_from_email );?></label>
				</td>
			</tr>
		</tbody>
		</table>
		...
		<h3><?php _e('Modify System-generated Email Templates', 'bella-membership-plugin' );?>:</h3>
		<?php 
		...
		?>		
		<p><?php _e('To modify the subject line and body content of system generated emails, <a title="Bella Membership Plugin - Email Templates Plugin" target="_blank" href="' . wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=pmpro-email-templates-addon'), 'install-plugin_pmpro-email-templates-addon') . '">Install and Activate the BM Plugin Email Templates add on</a>.', 'bella-membership-plugin' ); ?></p>					
		*/ ?>
		
		<h3><?php _e('Send the site admin emails', 'bella-membership-plugin' );?>:</h3>
		
		<table class="form-table">
		<tbody>                
			<tr>
				<th scope="row" valign="top">
					<label for="email_admin_checkout"><?php _e('Checkout', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
					...
					<label for="email_admin_checkout"><?php _e('when a member checks out.', 'bella-membership-plugin' );?></label>
				</td>
			</tr>
			<tr>
				<th scope="row" valign="top">
					<label for="email_admin_changes"><?php _e('Admin Changes', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
					...
					<label for="email_admin_changes"><?php _e('when an admin changes a user\'s membership level through the dashboard.', 'bella-membership-plugin' );?></label>
				</td>
			</tr>
			<tr>
				<th scope="row" valign="top">
					<label for="email_admin_cancels"><?php _e('Cancellation', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
					...
					<label for="email_admin_cancels"><?php _e('when a user cancels his or her account.', 'bella-membership-plugin' );?></label>
				</td>
			</tr>
			<tr>
				<th scope="row" valign="top">
					<label for="email_admin_billing"><?php _e('Bill Updates', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
					...
					<label for="email_admin_billing"><?php _e('when a user updates his or her billing information.', 'bella-membership-plugin' );?></label>
				</td>
			</tr>
		</tbody>
		</table>
		
		<h3><?php _e('Send members emails', 'bella-membership-plugin' );?>:</h3>
		
		<table class="form-table">
		<tbody>                
			<tr>
				<th scope="row" valign="top">
					<label for="email_member_notification"><?php _e('New Users', 'bella-membership-plugin' );?>:</label>
				</th>
				<td>
					...
					<label for="email_member_notification"><?php _e('Default WP notification email. (Recommended: Leave unchecked. Members will still get an email confirmation from BM Plugin after checkout.)', 'bella-membership-plugin' );?></label>
				</td>
			</tr>
		</tbody>
		</table>
