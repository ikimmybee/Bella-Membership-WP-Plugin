...
if($gateway_environment == "sandbox")
	$pmpro_reports['sales'] = __('Sales and Revenue (Testing/Sandbox)', 'bella-membership-plugin' );
else
	$pmpro_reports['sales'] = __('Sales and Revenue', 'bella-membership-plugin' );
...
<span id="pmpro_report_sales">
	...
	<thead>
		<tr>
			<th scope="col">&nbsp;</th>
			<th scope="col"><?php _e('Sales', 'bella-membership-plugin' ); ?></th>
			<th scope="col"><?php _e('Revenue', 'bella-membership-plugin' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<tr>
		...
		<tr>
			<th scope="row"><?php _e('This Year', 'bella-membership-plugin' ); ?></th>
...
function pmpro_report_sales_page()
{
	...
	<h1>
		<?php _e('Sales and Revenue', 'bella-membership-plugin' );?>
	</h1>
	...
	<div class="tablenav top">
		...
		<input type="submit" class="button action" value="<?php _e('Generate Report', 'bella-membership-plugin' );?>" />
	</div>
