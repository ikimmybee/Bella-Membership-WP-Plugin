<?php
		...
		<div id="pmpro_report_<?php echo $report; ?>" class="postbox">			
			...
			<div class="inside">
				...
				<p style="text-align:center;">
					<a class="button button-primary" href="<?php echo admin_url("admin.php?page=pmpro-reports&report=" . $report);?>"><?php _e('Details', 'bella-membership-plugin' );?></a>
				</p>
				<?php } ?>
			</div>
		</div>
	...
	else
	{
		...
		?>
		<hr />
		<a class="button button-primary" href="<?php echo admin_url("admin.php?page=pmpro-reports");?>"><?php _e('Back to Reports Dashboard', 'bella-membership-plugin' );?></a>
		<?php
	}
